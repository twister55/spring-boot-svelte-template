...
<div class="counter">
	<button type="button" onclick={() => (count.target -= 1)} aria-label="Decrease the counter by one">
	...
	<button type="button" onclick={() => (count.target += 1)} aria-label="Increase the counter by one">
		<svg aria-hidden="true" viewBox="0 0 1 1">
